...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('excss/image/fav.png')}}">
    ...
    <link rel="stylesheet" href="{{asset('excss/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('excss/perfect-scrollbar.min.css')}}">
    <link rel="stylesheet" href="{{asset('excss/jquery.datepicker.min.css')}}">
    <!-- calander -->
